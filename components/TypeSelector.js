...
export default function TypeSelector({ value, onChange }) {
  ...
  useEffect(() => {
    ...
    onChange(formData);
  }, [saleType, usage, propertyStatus, affordable, affordableType, tenure, category, subType, finalType, auctionDate]);

  const categoryOptions = {
    'Bungalow / Villa': [
      'Bungalow', 'Link Bungalow', 'Twin Villa', 'Zero-Lot Bungalow', 'Bungalow land'
    ],
    'Apartment / Condo / Service Residence': [
      'Apartment', 'Condominium', 'Flat', 'Service Residence', 'Penthouse'
    ],
    'Semi-Detached House': [
      'Cluster House', 'Semi-Detached House'
    ],
    'Terrace / Link House': [
      '1-storey Terraced House', '1.5-storey Terraced House', '2-storey Terraced House', '2.5-storey Terraced House', '3-storey Terraced House', '3.5-storey Terraced House', '4-storey Terraced House', '4.5-storey Terraced House', 'Terraced House', 'Townhouse'
    ],
    'Business Property': [
      'Hotel / Resort', 'Hostel / Dormitory', 'Boutique Hotel', 'Office', 'Office Suite', 'Business Suite', 'Retail Shop', 'Retail Space', 'Retail Office', 'Shop', 'Shop / Office', 'Sofo', 'Soho', 'Sovo', 'Duplex', 'Triplex', 'Dual Key', 'Commercial Bungalow', 'Commercial Semi-Detached House', 'Mall / Commercial Complex', 'School / University', 'Hospital / Medical Centre', 'Mosque / Temple / Church', 'Government Office', 'Community Hall / Public Utilities'
    ],
    'Industrial Property': [
      'Factory', 'Cluster Factory', 'Semi-D Factory', 'Detached Factory', 'Terrace Factory', 'Warehouse', 'Showroom cum Warehouse', 'Light Industrial', 'Heavy Industrial'
    ],
    Land: [
      'Agricultural Land', 'Industrial Land', 'Commercial Land', 'Residential Land', 'Oil Palm Estate', 'Rubber Plantation', 'Fruit Orchard', 'Paddy Field', 'Vacant Agricultural Land'
    ]
  };

  const affordableOptions = [
    'Rumah Mampu Milik', 'PPR', 'PR1MA', 'Rumah Selangorku', 'Rumah WIP (Wilayah Persekutuan)', 'Rumah Mampu Milik Johor (RMMJ)', 'Rumah Mesra Rakyat', 'Rumah Idaman (Selangor)'
  ];

  const tenureOptions = [
    'Freehold', 'Leasehold', 'Bumi Lot', 'Malay Reserved Land', 'Private Lease Scheme', 'State Lease Land', 'Strata Leasehold', 'Perpetual Lease'
  ];
      ...
      {showCategory && (
        <>
          <div>
            ...
            <select className="w-full border rounded p-2" value={category} onChange={(e) => {
