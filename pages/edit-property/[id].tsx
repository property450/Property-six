...
  type_group: 'Bungalow / Villa',
  type_detail: 'Link Bungalow',
  type: 'Residential > Bungalow / Villa > Link Bungalow' // 冗余字段，仅用于展示
}

}

function buildTypeString(obj: { category: string, group?: string, type?: string }) {
  ...
  return (
    <div className="p-4 max-w-2xl mx-auto">
      ...
      <form onSubmit={handleUpdate} className="space-y-4">
        ...
        <TypeSelector
  value={parseTypeString(property.type)}
  onChange={(val) => setProperty((p) => ({ ...p, type: buildTypeString(val) }))}
 />
